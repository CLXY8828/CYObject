				...
				<div class="col-lg-6 col-xs-12 col-lg-offset-3">
					<div class="panel panel-default">
					  <div class="panel-body">
						 ...
						 <br />
						 <div class="row">
						 	<a href="<%=request.getContextPath()%>/users/security.do?method=changepasswordphonepage">
					  		<div class="col-lg-8 col-xs-12 col-lg-push-2 " >
					  			<div class="panel panel-default">
								  <div class="panel-body">
								  	<div class="col-lg-3 col-xs-3" style="padding-top: 9px;">
								  		<img src="../img/211.png" alt="..." class="img-rounded" style=" width: 30px;">
								  	</div>
						 ...
						 <br />
						 <div class="row">
						 	<a href="<%=request.getContextPath()%>/users/security.do?method=changepasswordpasspage">
					  		<div class="col-lg-8 col-xs-12 col-lg-push-2 " >
					  			<div class="panel panel-default">
								  <div class="panel-body">
								  	<div class="col-lg-3 col-xs-3" style="padding-top: 9px;">
								  	...
								  	<div class="col-lg-9 col-xs-9 col-lg-pull-1" style="padding-left: 0px;">
								  		<p><h4 style="color: black;">原密码验证</h4></p>
									  	<footer style="color: #888888;" >通过密码验证</footer>
								  	</div>
								  </div>
								</div>
					  		</div>
