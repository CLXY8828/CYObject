		...
		<script type="text/javascript">
		    ...
		    function yz()
		    {
		    	...
		    	else
		    	{
					...
					var ss=$.post(url,{code:yzm},function(data){
						if (data=="no") {
							$("#nr").html("验证码输入有误！");
				    		$("#error").show();
				    		return;
		    ...
		    function phoneyz()
		    {
		    	...
		    	{
		    		var url="<%=request.getContextPath()%>/users/security.do?method=formphone";
					$.post(url,{code:yzm},function(data){
						if (data=="no") {
					  ...
					  <div class="panel-body">
					  	<div class="col-lg-10 col-xs-12 col-lg-push-1" style="padding-top: 50px;">
							  ...
							  <div class="panel-body">
								 ...
								 <div class="row">
							  		<div class="col-lg-8 col-xs-11 col-lg-push-2 col-xs-push-1" >
							  			<p>请通过手机号${fn:substring(user.phone, 0, 3)}***${fn:substring(user.phone, 7, -1)}接收短信验证码</p>
							  		</div>
								 </div>
								 <div class="row">
							  		<div class="col-lg-8 col-xs-11 col-lg-push-2 col-xs-push-1" >
