			...
			<div class="modal fade" id="exportall" tabindex="-1" role="dialog" aria-labelledby="modaltitle" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<span class="h4" style="margin-left: 10%;">你将导出该班级学生信息详情表</span>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭
							</button>
									...
									<div class="modal-body" style="font-size: 14px; margin-left: 20px;">
										<div>
											...
											<div class="row" style="margin-top: 1.5%;">
												<span style="margin-left: 2%;">
													毕业去向：
													<input type="text" name="where_edit" id="where_edit" value="" style="width: 30%;outline: none;border: none;" disabled="disabled"/>
												</span>
										...
										<div style="margin-top: 2%;">
											...
											<div class="row" style="margin-top: 1.5%;">
												<span style="margin-left: 2%;">
													单位组织机构代码：
													<input type="text" name="organiza_edit" id="organiza_edit" value="" style="width: 25.5%;outline: none;border: none;" disabled="disabled"/>
												</span>
												<span style="margin-left: 6%;">
													单位性质：
													<input type="text" name="unit_edit" id="unit_edit" value="" style="width: 30%;outline: none;border: none;" disabled="disabled"/>
												</span>
											</div>
											<div class="row" style="margin-top: 1.5%;">
												<span style="margin-left: 2%;">
													单位名称：
													<input type="text" name="organizaname_edit" id="organiza_edit" value="" style="width: 25.5%;outline: none;border: none;" disabled="disabled"/>
												</span>
												<span style="margin-left: 6%;">
													单位行业：
													<input type="text" name="industry_edit" id="industry_edit" value="" style="width: 35%;outline: none;border: none;" disabled="disabled"/>
												</span>
											</div>
											<div class="row" style="margin-top: 1.5%;">
												<span style="margin-left: 2%;">
													单位所在地：
													<input type="text" name="organizaaddress_edit" id="organizaaddress_edit" value="" style="width: 30%;outline: none;border: none;" disabled="disabled"/>
												</span>
												<span style="margin-left: 2%;">
													工作职业类别：
													<input type="text" name="industry_edit" id="industry_edit" value="" style="width: 30%;outline: none;border: none;" disabled="disabled"/>
												</span>
											</div>
										</div>
										<div style="margin-top: 2%;">
											...
											<div class="row" style="margin-top: 1.5%;">
												<span style="margin-left: 2%;">
													单位联系人：
													<input type="text" name="work_contact" id="work_contact" value="" style="width: 7%;outline: none;border: none;" disabled="disabled"/>
												</span>
												<span style="margin-left: 3%;">
													联系人电话：
													<input type="text" name="contact_tel_edit" id="contact_tel_edit" value="" style="width: 13%;outline: none;border: none;" disabled="disabled"/>
												</span>
												<span style="margin-left: 5%;">
													联系人电子邮箱：
													<input type="email" name="contact_email_edit" id="contact_email_edit" value="" style="width: 15%;outline: none;border: none;" disabled="disabled"/>
												</span>
											</div>
											<div class="row" style="margin-top: 1.5%;">
												<span style="margin-left: 2%;">
													联系人传真：
													<input type="text" name="contact_fax_edit" id="contact_fax_edit" value="" style="width: 10%;outline: none;border: none;" disabled="disabled"/>
												</span>
												<span>
													单位地址：
													<input type="text" name="work_address" id="work_address" value="" style="width: 23%;outline: none;border: none;" disabled="disabled"/>
												</span>
											</div>
										</div>
									</div>
										...
										<div class="modal-body" style="font-size: 14px; margin-left: 20px;">
											...
											<div style="margin-top: 2%;">
												...
												<div class="row" style="margin-top: 1.5%;">
													<span style="margin-left: 2%;">
														单位组织机构代码：
														<input type="text" name="organiza_edit" id="organiza_edit" value="" style="width: 25.5%;" />
													</span>
													<span style="margin-left: 6%;">
														单位性质：
														<input type="text" name="unit_edit" id="unit_edit" value="" style="width: 30%;" />
													</span>
												</div>
												<div class="row" style="margin-top: 1.5%;">
													<span style="margin-left: 2%;">
														单位名称：
														<input type="text" name="organizaname_edit" id="organiza_edit" value="" style="width: 25.5%;" />
													</span>
													<span style="margin-left: 6%;">
														单位行业：
														<input type="text" name="industry_edit" id="industry_edit" value="" style="width: 35%;" />
													</span>
												</div>
												<div class="row" style="margin-top: 1.5%;">
													<span style="margin-left: 2%;">
														单位所在地：
														<input type="text" name="organizaaddress_edit" id="organizaaddress_edit" value="" style="width: 30%;" />
													</span>
													<span style="margin-left: 2%;">
														工作职业类别：
														<input type="text" name="industry_edit" id="industry_edit" value="" style="width: 30%;" />
													</span>
												</div>
											</div>
											<div style="margin-top: 2%;">
												...
												<div class="row" style="margin-top: 1.5%;">
													<span style="margin-left: 2%;">
														单位联系人：
														<input type="text" name="work_contact" id="work_contact" value="" style="width: 7%;" />
													</span>
													<span style="margin-left: 3%;">
														联系人电话：
														<input type="text" name="contact_tel_edit" id="contact_tel_edit" value="" style="width: 13%;" />
													</span>
													<span style="margin-left: 5%;">
														联系人电子邮箱：
														<input type="email" name="contact_email_edit" id="contact_email_edit" value="" style="width: 15%;" />
													</span>
												</div>
												<div class="row" style="margin-top: 1.5%;">
													<span style="margin-left: 2%;">
														联系人传真：
														<input type="text" name="contact_fax_edit" id="contact_fax_edit" value="" style="width: 10%;"/>
													</span>
													<span>
														单位地址：
														<input type="text" name="work_address" id="work_address" value="" style="width: 23%;"/>
													</span>
												</div>
											</div>
										</div>
