			...
			<div class="navbar-header" style="width: 100%;background-color:#011536;">
				<div style="margin-left: 10%;">
					...
					<span class="h2" style="font-size:28px;">
						<a href="<%=request.getContextPath() %>/managerjsp/index.jsp" class="btn btn-info" style="width: 80px;margin-left: 64%;">返回</a>
					</span>
				</div>
			</div>
		</div>
				...
				<div class="content">
					...
					<div class="content_right tab-content" style="box-shadow: 1 0 3px 3px gray;">
						<div id="analyze" class="tab-pane" style="width: 100%;height: 100%;">
							<iframe src="<%=request.getContextPath()%>/gradework/work.do?method=queryanalyze&page=1&department_id=${department_id}" width="100%" height="100%"></iframe>
						</div>
						<div id="gradeinfo" class="tab-pane active" style="width: 100%;height: 100%;">
							<iframe src="<%=request.getContextPath()%>/gradework/work.do?method=queryworkinfo&page=1&department_id=${department_id}" width="100%" height="100%"></iframe>
						</div>
						<div id="gradeunwork" class="tab-pane" style="width: 100%;height: 100%;">
							<iframe src="<%=request.getContextPath()%>/gradework/work.do?method=queryunworkinfo&page=1&department_id=${department_id}" width="100%" height="100%"></iframe>
						</div>
						<div id="notregi" class="tab-pane" style="width: 100%;height: 100%;">
							<iframe src="gradenotregister.html" width="100%" height="100%"></iframe>
						</div>
					</div>
				</div>
			</div>
