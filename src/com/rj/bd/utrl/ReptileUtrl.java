...
public class ReptileUtrl {
	 ...
	 * @throws PcException
	 */
	public static List<String> getAllByUrl(String urlmethod) throws PcException{
	 ...
	 * @throws PcException
	 */
	public static List<String> getOtherAllByUrl(String otherurlmethod) throws PcException{
	 ...
	 * @throws PcException
	 */
	private static List<String> getAll(WebDriver driver) throws PcException {
